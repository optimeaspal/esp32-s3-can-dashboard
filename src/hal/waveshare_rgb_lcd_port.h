...
// Touch-Controller GT911 aktivieren (0 = deaktiviert)
#define CONFIG_EXAMPLE_LCD_TOUCH_CONTROLLER_GT911 1

// I2C Bus (CH422G IO-Expander + GT911 Touch)
...
// RGB-Datenpins ST7701 (16-Bit-Bus)
...
// GPIO4 wird für den CH422G-gesteuerten Touch-Reset benötigt
#define GPIO_TOUCH_CTRL_PIN     4
#define GPIO_TOUCH_CTRL_SEL     (1ULL << GPIO_TOUCH_CTRL_PIN)
